...
- **Guests are never contacted by PlusOne.** The venue may contact you about your request or, if you opted in, about its upcoming nights. [Planned: an optional confirmation e-mail to a requester about the venue's decision, sent on the venue's behalf. Not live; this policy and the Subprocessor List will be updated before it is.]
