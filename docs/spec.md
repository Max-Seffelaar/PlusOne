...
| Admin & Finance | **Verplichte MFA (TOTP-app)** | Via Supabase native MFA. In RLS wordt afgedwongen (AAL2) dat quota-verhogingen, rolwijzigingen en audit-log-inzage alleen werken met een MFA-geverifieerde sessie. Gestolen mailbox allleen is dan niet genoeg. |
