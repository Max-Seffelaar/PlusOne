...
- Tests: `use-door-variant.test.tsx` (23 — matrix × hook/branch/route, no
  remount on pointer/width change, SSR placeholder); `app.auto-open.test.tsx`
  now stubs a fine pointer. Not run here: pgTAP, e2e (no Supabase/Docker) — CI.
