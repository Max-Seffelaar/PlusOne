...
2. **iOS/WKWebView:** pagina wordt gesuspend bij schermvergrendeling/achtergrond → mesh valt weg en rejoint bij wake. SOP: schermen aan; `wakeLock` later. Batterijkosten van ≤ 8 peers + 10s-heartbeats over een 6-uurs nacht: laag maar ongetest.
