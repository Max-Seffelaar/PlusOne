...
export const links = {
  ...
  newInfluencerPlaceholder: 'Promoter name',
  ...
  archiving: 'Archiving…',
  errIdentity: 'Pick a promoter or give the link a label.',
  errNewInfluencerName: 'Enter a name for the new promoter.',
  ...
  influencersEmpty: 'No promoters yet. Add the people who bring the crowd.',
  influencersExplainer:
    'Each promoter gets their own request links per event, so you can see exactly who delivers: views, requests, approvals.',
  influencersAdminOnly: 'Only admins can manage promoters.',
  linksCountOne: '{n} link',
  linksCountMany: '{n} links',
  addInfluencerTitle: 'New promoter',
  editInfluencerTitle: 'Edit promoter',
  nameLabel: 'Name',
  ...
  errInfluencerSave: "Couldn't save the promoter.",
  archiveInfluencerCta: 'Archive promoter',
