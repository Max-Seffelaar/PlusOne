...
export const settings = {
  ...
  team: {
    ...
    invitesLabel: 'Open invites',
    invitesEmpty: 'No open invites.',
  ...
  venue: {
    ...
    defaultsLabel: 'Guest list defaults',
    defaultQuotaTitle: 'Default quota per member',
    defaultQuotaSub: 'Guests per event, override per person',
