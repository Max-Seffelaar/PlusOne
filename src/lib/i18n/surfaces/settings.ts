...
export const settings = {
  ...
  more: {
    ...
    auditSub: 'Who did what, when · MFA',
    ...
    sessionsSub: 'Log out team devices remotely · MFA',
  ...
  profile: {
    ...
    mfaChipRequired: 'REQUIRED',
    mfaChipOn: 'ON',
    mfaChipOff: 'OFF',
    mfaEnable: 'Turn on',
    mfaDisable: 'Turn off',
    mfaActivateNow: 'Activate now',
    ...
    mfaDisableNote:
      'Your role doesn’t require two-factor, but turning it off lowers your account security. You can turn it back on later.',
